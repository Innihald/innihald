...
final class Version20200930145823 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE physical_file (id INT NOT NULL, document_id INT DEFAULT NULL, filename VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, type VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
